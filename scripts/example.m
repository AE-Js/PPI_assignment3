%% LEGACY CODE DOES NOT WORK ANYMORE!!!!
%% SEE OTHER SCRIPTS ON HOW TO UPDATE THIS CODE!!
...
plot_map(y_LatLon,Interior_ModelU(end),'field_name','all','radial_point',floor(Numerics.Nr*0.5),'plot_title','Variable Model');
plot_map(y_LatLon,Interior_ModelU(end),'field_name','test_strain_stress','radial_point',floor(Numerics.Nr*0.5),'plot_title','(2,0)');%,'save_plot',plot_name1)

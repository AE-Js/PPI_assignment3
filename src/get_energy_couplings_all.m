...
%% Function
function [ECouplings] = get_energy_couplings_all(Forcing,Numerics,varargin)
verbose = 0;
...
if verbose == 1
    ECouplings = get_energy_couplings(n_sol,m_sol,Numerics,'verbose');
else
    ECouplings = get_energy_couplings(n_sol,m_sol,Numerics);
end

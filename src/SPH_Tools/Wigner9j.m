...
%         J9=j9;
    ...
    kk = find ( j1(1:NJ-1)==j1(2:NJ) & j2(1:NJ-1)==j2(2:NJ) & j3(1:NJ-1)==j3(2:NJ) & j4(1:NJ-1)==j4(2:NJ) & j5(1:NJ-1)==j5(2:NJ) & j6(1:NJ-1)==j6(2:NJ) & j7(1:NJ-1)==j7(2:NJ) & j8(1:NJ-1)==j8(2:NJ) & j9(1:NJ-1)==j9(2:NJ) );
    if ~isempty(kk)
        NK(kk)=0;
    end
